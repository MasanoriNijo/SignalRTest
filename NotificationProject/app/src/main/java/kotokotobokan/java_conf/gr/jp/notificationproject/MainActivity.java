...
//        });
        ...
        btn4_ = findViewById(R.id.button4);
        btn4_.setOnClickListener(this);
        ...
        fcmHandler = new FCMHandler(this);
...
//    private void GetAOuth() {
//        FileInputStream serviceAccount = null;
//        try {
//            serviceAccount = (FileInputStream) getAssets().open("notificationproject-a0485-firebase-adminsdk-qa7nw-71043b1ab8.json");
//
//            FirebaseOptions options = new FirebaseOptions.Builder()
//                    .setCredentials(GoogleCredentials.fromStream(serviceAccount))
//                    .setDatabaseUrl("https://notificationproject-a0485.firebaseio.com")
//                    .build();
...
//                sgr_.MsgSend("TestMsg:"+txt2_.getText().toString());
            ...
            case R.id.button3: {
                ...
                fcmHandler.MadeOAuth2Token();

//                    txt3_.setText(FirebaseInstanceId.getInstance().getToken());
//                Log.d("xxx", "xxx:FirebaseInstanceId.getInstance().getToken()"+FirebaseInstanceId.getInstance().getToken());
...
//                new GetAsyncTask(this).execute(getParams);
            ...
            case R.id.button4: {
                fcmHandler.SendMessageToGroup(txt3_.getText().toString(), txt4_.getText().toString());
                break;
            }
